...
document.querySelectorAll('.suggest').forEach((el) => observer.observe(el));

document.querySelectorAll('.suggform').forEach((el) => observer.observe(el));

document.querySelectorAll('.button').forEach((el) => observer.observe(el));